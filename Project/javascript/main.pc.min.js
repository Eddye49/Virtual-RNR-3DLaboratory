...
function checkBookConfigRestrictedKey(a,b){var c,d,e,f,g,h=function(){return(null==(c=window.tmpBookConfig)?void 0:null==(d=c.power_info)?void 0:d.power)||(null==(e=window.bookConfig)?void 0:null==(f=e.power_info)?void 0:f.power)||(null==(g=window.userInfo)?void 0:g.power)||null},l=function(r){var t;if(!("appLogoIcon"===a&&0<Number(null==(t=window.userInfo)?void 0:t.ai))){if(checkPermission(a,r))return specialHandlers[a]?specialHandlers[a]():b;if("appLogoIcon"===a&&(r=String(window.bookConfig&&window.bookConfig.appLogoIcon||
window.tmpBookConfig&&window.tmpBookConfig.appLogoIcon||("undefined"!==typeof b?b:"")).trim(),"string"==typeof r&&(r=r.replaceAll("\\/","/",!0),r=r.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(r)))return""}},n,k,m,p,q;if((null==(n=window.tmpBookConfig)?0:null==(k=n.power_info)?0:k.power)||(null==(m=window.bookConfig)?0:null==(p=m.power_info)?0:p.power)||(null==(q=window.userInfo)?0:q.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(h());window.eventEmitter.on("loadUserInfo",
function(r){return l(h())})};(function(a){a.fn.bind||(a.fn.bind=function(b,c,d){return this.on(b,null,c,d)});a.fn.unbind||(a.fn.unbind=function(b,c){return this.off(b,c)})})(jQuery);
