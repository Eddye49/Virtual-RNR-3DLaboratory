...
function checkBookConfigRestrictedKey(b,c){var d,e,f,g,h,k=function(){return(null==(d=window.tmpBookConfig)?void 0:null==(e=d.power_info)?void 0:e.power)||(null==(f=window.bookConfig)?void 0:null==(g=f.power_info)?void 0:g.power)||(null==(h=window.userInfo)?void 0:h.power)||null},l=function(r){var u;if(!("appLogoIcon"===b&&0<Number(null==(u=window.userInfo)?void 0:u.ai))){if(checkPermission(b,r))return specialHandlers[b]?specialHandlers[b]():c;if("appLogoIcon"===b&&(r=String(window.bookConfig&&window.bookConfig.appLogoIcon||
window.tmpBookConfig&&window.tmpBookConfig.appLogoIcon||("undefined"!==typeof c?c:"")).trim(),"string"==typeof r&&(r=r.replaceAll("\\/","/",!0),r=r.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(r)))return""}},m,q,p,x,t;if((null==(m=window.tmpBookConfig)?0:null==(q=m.power_info)?0:q.power)||(null==(p=window.bookConfig)?0:null==(x=p.power_info)?0:x.power)||(null==(t=window.userInfo)?0:t.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(k());window.eventEmitter.on("loadUserInfo",
function(r){return l(k())})}checkReportConfig=function(){changeBookConfigValue("EnableReportButton",getConfigValue("EnableReportButton",!1))};var tmpBookConfig={};
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026070801",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
